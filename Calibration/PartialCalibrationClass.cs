...
namespace KinectGame.Calibration
{
    internal class PartialCalibrationClass
    {
        ...
        // Add methods to add calibration points
        ...
        {
            return m_calibPoints.Count == 4 && m_skeletonCalibPoints.Count == 4;
        }
